...
path="/data_disk/home/user/Patch-NetVLAD/patchnetvlad/mobius/union"
file_list=os.listdir(path)

for i in file_list:
    print(i)
    # f = open("patchnetvlad/dataset_imagenames/image_names_index.txt", 'a')
    f = open("/data_disk/home/user/Patch-NetVLAD/patchnetvlad/dataset_imagenames/mobius_db.txt", 'a')
    f.write(i+'\n')
